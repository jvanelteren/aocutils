...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'aocutils'},
  'syms': { 'aocutils.cfg': { 'aocutils.cfg.State': ('earleyparser.html#state', 'aocutils/cfg.py'),
                              'aocutils.cfg.State.__repr__': ('earleyparser.html#state.__repr__', 'aocutils/cfg.py'),
                              'aocutils.cfg.State.is_complete': ('earleyparser.html#state.is_complete', 'aocutils/cfg.py'),
                              'aocutils.cfg.State.nextsym': ('earleyparser.html#state.nextsym', 'aocutils/cfg.py'),
                              'aocutils.cfg.find': ('earleyparser.html#find', 'aocutils/cfg.py'),
                              'aocutils.cfg.parse': ('earleyparser.html#parse', 'aocutils/cfg.py'),
                              'aocutils.cfg.printparse': ('earleyparser.html#printparse', 'aocutils/cfg.py')},
