...
# %% auto 0
__all__ = ['Robot', 'md5', 'binarysearch', 'deduce_matches', 'find_pattern_in_iter', 'find_repeat', 'find_cycle', 'UnionFind',
           'Octree', 'LazySegmentTree']
...
class Octree():
    ...
    def hits(self, other):
        # checks if Octree is hit by a Robot (distance < power of robot)
        dis = 0
