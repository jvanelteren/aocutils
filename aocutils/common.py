...
# %% auto 0
__all__ = ['cat', 'chainit', 'copy_func', 'patch_to', 'patch', 'to_int', 'ints', 'flatten', 'rev', 'zippify', 'list_multiply',
           'data', 'quantify', 'first', 'multidict', 'atom', 'atoms', 'list_atoms', 'dotproduct', 'mapt']
